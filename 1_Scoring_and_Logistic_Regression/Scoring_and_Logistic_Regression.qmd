...
load(file='C:/Users/Alex/Documents/GitHub/Scoring_Alex/teaching_Scoring/data/mixture.example.RData')
...
(default_data_binned <- default_data %>%
    mutate(balance_bins = cut(balance, breaks = seq(0, 3000, class_width),right = FALSE, dig.lab = 4),min = floor(balance / class_width) * class_width,max = if_else(balance == 0 , 1,ceiling(balance / class_width))*class_width)  # customers with 0$ balance should belong to [0, width) class or be excluded 
...
```{r, message=FALSE}
#| code-fold: show
load('C:/Users/Alex/Documents/GitHub/Scoring_Alex/teaching_Scoring/data/germancredit.RData')
